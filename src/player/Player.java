...
public class Player extends BorderPane {
	     ...
	     * 
	     */
	    public Player(Canvas canvas, int x_screen_position, int y_screen_position,Stage stage, Scene scene) {
    	...
    	//
		/**
		 * Switches the programs scene to the previously used scene
		 */
